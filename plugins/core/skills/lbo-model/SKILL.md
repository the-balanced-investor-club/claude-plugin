...
* **Default fill palette:**
  * **Section headers** (Sources & Uses, Operating Model, etc.): Ink `#28333C` with white bold text
  * **Column headers** (Year 1, Year 2, etc.): Pale green `#E7EFE6` with black bold text
  ...
  * **Key outputs** (IRR, MOIC, Exit Equity): Medium green `#CBDCCB` with black bold text
...
* **Highlight the center cell** — medium-green fill (`#CBDCCB`) + bold font so the base case is visually anchored.
...
- [ ] Center cell is highlighted (medium-green fill `#CBDCCB`, bold font)
