...
The current price sits at the low end of the DCF range. That means the market is assuming something closer to the bear case. Whether it is right is the question this report leaves with the reader.
```
...
Precedent Trans.        $70     $79     $88     10%     $7.90
                                                        -------
Blended implied value                           100%    $59.30

Implied value range:  $42 — $59 — $88   (low / blended / high)

Current Price (as of [Date]):    $42.00
The current price sits at the BOTTOM of the range, which means the market is
assuming something closer to the DCF's bear case than to the comps. Whether the
market is wrong or the comps are is the question this report leaves with the reader.
```

**Note the spread: $42 to $88.** The methods disagree by more than 2×. Averaging them into "$59.00"
hides that disagreement behind a decimal point, and a decimal point next to the current price is a
recommendation. **Show the spread. Explain why the methods disagree.** That disagreement is the most
...
### Step 6: The Range, the Sensitivity, and the Falsifier
...
Implied value range:    $42 — $59 — $88   (low / blended / high)
                        The current price sits at the BOTTOM of the range.

The methods disagree by more than 2×. DCF says $42-51; comps say $64-78.
That gap is not noise — it means the market is pricing this company like
its own cash flows justify, and the peer group like it deserves a re-rating.
Which of those is right is the question. This report does not answer it.

What the current price already assumes:
                        Revenue growth of X% and a terminal margin of Y% —
                        [above / below / in line with] anything the company
                        has yet delivered.
...
WHAT WOULD PROVE THIS READ WRONG:
                        [The specific, checkable condition. Not "competition
                         could increase" — that is a platitude. "If gross
                         margin has not reached 22% by FY28, the base case
                         collapses to the DCF bear."]
...
7. **Implied Returns Check**
   ...
   - Is that consistent with the range you derived, and with what the current price already assumes?
...
**Contents** (4-6 pages):
- Executive summary with the implied value range and the falsifier
...
- What the range says, what moves it, and what would prove the read wrong (1 page)
...
7. Arrive at a defensible implied value RANGE — never a single target figure
8. State the falsifier: the specific, checkable condition that would prove this read wrong. NEVER a buy/hold/sell recommendation
...
The implied value range, its sensitivity and the falsifier are what the report leaves the reader with. There is no rating and no price target: a point estimate next to the current price is a recommendation, whatever it is called.
